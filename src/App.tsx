...
class App extends React.Component {
  ...
  public submitStart = () => {
    ...
    window.NativeNotice.send("hunt-start", {
      ...
      JJC_ICON_LOCATION: JJC_ICON_LOCATION,
      HUNT_MATCH_LOCATION: HUNT_MATCH_LOCATION,
      HUNT_START_LOCATION: HUNT_START_LOCATION,
      HUNT_SURRENDDER_LOCATION: HUNT_SURRENDDER_LOCATION,
      HUNT_STOP_LOCATION: HUNT_STOP_LOCATION,
      CHARACTER_HEAD_COORDINATE: CHARACTER_HEAD_COORDINATE,
